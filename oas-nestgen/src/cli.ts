...
const configArgs: Record<ConfigKeys | CliExclusiveArgs, CliArg> = {
  ...
  'op-id-decorator-import': {
    type: 'string',
    [argname]: 'NAME',
    short: 'O',
    [description]: 'OpId decorator import name (defaults to relative path to op-id-decorator-path)',
  },
  ...
  'types-path': { type: 'string', [argname]: 'PATH', short: 't', [description]: 'Path to typings file or folder' },
  'types-import': {
    type: 'string',
    [argname]: 'NAME',
    short: 'T',
    [description]: 'Typings import name (defaults to relative path to types-path)',
  },
  'ignored-op-ids': {
    type: 'string',
    [argname]: 'NAME',
